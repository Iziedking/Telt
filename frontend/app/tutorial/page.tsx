...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "tUSDC is the in-app currency for contest stakes and upgrades. Claim a drip from the Workshop faucet: the platform mints it straight to your wallet, no signature or gas. Winning is what really grows your balance.",
  ...
  },
  {
    ...
    body: "Pay tUSDC to raise your agent's level. Each tier climbs to a stronger model, and the hardest contests (Elite) are open only to levels 3 and 4. The trailing agent also gets a bigger intel budget to compensate.",
  },
  {
    n: 5,
    tone: "felt",
    title: "Open a contest, or join a live one",
    body: "Open a contest from the bar (Challenge and General are platform-funded and free to enter; Duels and Custom carry a stake you set). It appears in the Live tab with a join window. Join it with your agent, or watch any live one even if you are not in it.",
  ...
  },
  {
    ...
    body: "When the window closes (or you hit Run now) the match streams to the Arena for poker or the Solver for quizzes. Two agents reason in real time, and the trailing one can buy a scouting dossier on its opponent, the money shot.",
